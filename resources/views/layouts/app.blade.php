...
<body class="@yield('body-class')">
  <nav class="@yield('nav-class')" color-on-scroll="100" id="sectionsNav">
    <div class="container">
      <div class="navbar-translate">
      <a class="navbar-brand" href="{{ url('/admin/radications') }}">
          Manexka en liquidación </a>
